            ...
            case 4:
                return (
                    <div className="bg-white p-12 rounded-xl border border-secondary/20 text-center animate-fade-in max-w-2xl mx-auto">
                        ...
                        <h2 className="text-3xl font-extrabold text-secondary-dark mb-2">¡Vehículo Creado!</h2>
                        <p className="text-secondary mb-8 text-lg">
                            Se ha registrado correctamente el vehículo <strong>{formData.marca} {formData.modelo}</strong> ({formData.patente}).
                        </p>
                        <div className="flex justify-center gap-4">
                            <button onClick={() => navigate('/recursos/vehiculos')} className="text-secondary-dark bg-gray-100 hover:bg-gray-200 font-medium rounded-lg text-sm px-5 py-2.5 transition-all">
                                Volver al Listado
                            </button>
    ...
    return (
        <div className="container mx-auto px-4 py-8 max-w-5xl">
            <div className="mb-8 text-center">
                ...
                <h1 className="text-3xl md:text-4xl font-extrabold text-secondary-dark">Nuevo Vehículo</h1>
            </div>
